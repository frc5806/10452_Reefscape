...
public class NavXGyro extends AHRS{
    ...
    private NavXGyro() {
        // super(SPI.Port.kMXP); (Depreciated)
        super(NavXComType.kMXP_SPI);
        reset();
        zeroHeading = getNavHeading() + ((DriverStation.getAlliance().equals(DriverStation.Alliance.Red)) ? 90 : -90);
    ...
    public double getHeading() {
        return Math.IEEEremainder(-getNavAngle(), 360) - ((DriverStation.getAlliance().equals(DriverStation.Alliance.Red)) ? 180 : 0);
    }
